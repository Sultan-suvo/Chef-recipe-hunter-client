        ...
        <div className=''>
            <div className='container pt-16 bg-dark md:flex justify-around'>
                <div className='ms-4'>
                    ...
                    <p className='mt-2 text-slate-500'>Register and get notified about all the news & updates before it gets too late.</p>
                    <div>
                ...
                <div className='text-white ms-4 pb-4'>
                    ...
                    <hr style={{ borderColor: 'white', padding: '8px' }} />
                    <div className='d-flex items-center ms-8 mb-3'>
                        <FaMapMarkerAlt></FaMapMarkerAlt>
                        <span className='text-slate-500 ms-3'>787 Mark View Street,
                            <br />
                            New Town, California</span>
                    </div>
                    <div className='d-flex items-center ms-8'>
                        <FaPhone></FaPhone>
                        <span className='text-slate-500 ms-3'>666 444 0000</span>
                    </div>
                </div>
            </div>
            <div className='container text-center bg-slate-800 pt-8'>
                <p className='text-slate-400 ms-3'>All rights reserved. Your company name here.</p>
                <div className='text-white d-flex justify-center gap-3 text-2xl p-4'>
